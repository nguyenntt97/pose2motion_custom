...
from utils.bvh_writer import write_bvh
...
"""
corps_name_digidog = ['SKEL_Pelvis', 'SKEL_Spine0', 'SKEL_Spine1', 'SKEL_L_Clavicle', 'SKEL_L_UpperArm', 
                      'SKEL_L_Forearm', 'SKEL_L_Hand', 'SKEL_L_Finger00', 'SKEL_L_Finger01',  
                      'SKEL_R_Clavicle', 'SKEL_R_UpperArm', 'SKEL_R_Forearm', 'SKEL_R_Hand', 'SKEL_R_Finger00', 
                      'SKEL_R_Finger01', 'SKEL_Spine2', 'SKEL_Spine3', 'SKEL_Neck1', 
                      'SKEL_Neck2', 'SKEL_Head', 'SKEL_L_Thigh', 'SKEL_L_Calf', 'SKEL_L_Foot', 
                      'SKEL_L_Toe0', 'SKEL_L_Toe1', 'SKEL_R_Thigh', 'SKEL_R_Calf', 'SKEL_R_Foot', 
...
"""
ee_name_digidog = ['SKEL_L_Toe1', 'SKEL_R_Toe1', 'SKEL_Head', 'SKEL_L_Hand', 'SKEL_R_Hand']
# ee_name_example = ['LeftToe', 'RightToe', 'Head', 'LeftHand', 'RightHand']


corps_names = [corps_name_digidog]
ee_names = [ee_name_digidog]
"""
3.
