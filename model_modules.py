...
class EndEffectorLoss(nn.Module):
    def __init__(self,remove_virtual_node,window_size=-1,loss_type="bbox",with_root=False,datasetA=None,\
                                datasetB=None, velocity_virtual_node=None,consistency_loss=False,
                                use_global_y=False, foot_height_A=None,foot_height_B=None,use_mean_height=False,
                                ee_reweight=False):
